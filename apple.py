...
# Streamlit app
st.title("SHAP Analysis for Apple Quality")
...
for feature in X.columns:
    if feature in ['A_id', 'Size', 'Weight', 'Sweetness' 'Crunchiness',
...
# Display prediction
st.write(f"**Prediction:** {'Quality Good' if prediction == 0 else 'Quality Bad'}")
